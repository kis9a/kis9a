(() => {
  ...
  // sources/src/pages/images/index.js
  var format = "webp";
  var getIndexes = Http({
  ...
  var initIndexes = getIndexes;
  var initialState = [pureState, initIndexes];
  var shuffle = ([...array]) => {
  ...
  app({
    init: initialState,
    view: ({ indexes }) => h("div", { class: "container" }, [
      Header(),
      h("main", {}, [
        h("div", { class: "content indexes" }, indexes && indexes.map((s) => isFormat(s.name) && h("div", { class: "imgc" }, [
          h("img", {
            alt: s.name,
