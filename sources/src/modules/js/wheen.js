...
const wheen = ((window) => {
  ...
  const update = (dt) => {
    wheens.forEach((wheenChains) =>
      wheenChains.forEach((wheenChain) => wheenChain._update(dt))
    );
  };
  ...
  class WheenChain {
    ...
    stop() {
      wheens.set(
        this.target,
        wheens.get(this.target).filter((tweenChain) => tweenChain !== this)
      );
      this.stopped = true;
    ...
    applyArgs(args, snapshot, target, easing, setter) {
      Object.entries(args).forEach(([key, value]) => {
        ...
        if (typeof value === "object") {
          ...
          const targetValue =
            this.type === "BY" ? snapshot[key] + args[key] : args[key];
          const computedValue = easing(
            this.elapsedTime,
            startValue,
  ...
  Easing: {
    ...
    Expo: {
      ...
      easeInOut: function (t, s, e, i) {
        return 0 == t
          ...
          ? s + e
          : (t /= i / 2) < 1
          ? (e / 2) * Math.pow(2, 10 * (t - 1)) + s
          : (e / 2) * (2 - Math.pow(2, -10 * --t)) + s;
      },
    },
    Circ: {
      easeIn: function (t, s, e, i) {
      ...
      easeInOut: function (t, s, e, i) {
        return (t /= i / 2) < 1
          ? (-e / 2) * (Math.sqrt(1 - t * t) - 1) + s
          : (e / 2) * (Math.sqrt(1 - (t -= 2) * t) + 1) + s;
      },
    },
    Elastic: {
    ...
    Back: {
      easeIn: function (t, s, e, i, n) {
        return (
          null == n && (n = 1.70158), e * (t /= i) * t * ((n + 1) * t - n) + s
        );
      },
      easeOut: function (t, s, e, i, n) {
        return (
          null == n && (n = 1.70158),
          e * ((t = t / i - 1) * t * ((n + 1) * t + n) + 1) + s
        );
      },
      easeInOut: function (t, s, e, i, n) {
        return (
          null == n && (n = 1.70158),
          (t /= i / 2) < 1
            ? (e / 2) * (t * t * ((1 + (n *= 1.525)) * t - n)) + s
            : (e / 2) * ((t -= 2) * t * ((1 + (n *= 1.525)) * t + n) + 2) + s
        );
      },
    },
    Bounce: {
      ...
      easeInOut: function (t, s, e, i) {
        return t < i / 2
          ? 0.5 * Easing.Bounce.easeIn(2 * t, 0, e, i) + s
          : 0.5 * Easing.Bounce.easeOut(2 * t - i, 0, e, i) + 0.5 * e + s;
      },
    },
  },
  get: (...args) => wheen(...args),
