(() => {
  ...
  // sources/src/modules/js/snarkdown.js
  var TAGS = {
    "": ["<em>", "</em>"],
    _: ["<strong>", "</strong>"],
    "~": ["<s>", "</s>"],
  ...
  function parse(md, prevLinks) {
    ...
    function tag(token2) {
      var desc = TAGS[token2.replace(/\*/g, "_")[1] || ""], end = context[context.length - 1] == token2;
      if (!desc)
        return token2;
      if (!desc[1])
        return desc[0];
      context[end ? "pop" : "push"](token2);
      return desc[end | 0];
    }
    function flush() {
      let str = "";
    ...
    while (token = tokenizer.exec(md)) {
      ...
      if (prev.match(/[^\\](\\\\)*\\$/)) {
        ...
        var l = token[18].split("\n"), i = l.length, table = "", r = "td>";
        while (i--) {
          if (l[i].match(/^\|\s+---+.*$/)) {
            r = "th>";
            continue;
          }
          var c = l[i].split(/\|\s*/), j = c.length, tr = "";
          while (j--) {
  ...
  var Header = () => {
    ...
    let c = routes.find((v) => {
      return parse2(sn) === parse2(v.href);
    });
    if (!c) {
      c = { name: "" };
    }
  ...
  // sources/src/modules/js/subs/Keyboard.js
  function keyboardEffect(dispatch, props) {
    var removeListenerForEvent = makeRemoveListener.bind(null, document, dispatch, props.action);
  ...
  // sources/src/assets/svgs/information-circle.svg
  var information_circle_default = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">\n  <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>\n</svg>\n';

  // sources/src/assets/svgs/exclamation.svg
  var exclamation_default = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">\n  <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>\n</svg>\n';

  // sources/src/assets/svgs/check-circle.svg
  var check_circle_default = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">\n  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>\n</svg>\n';

  // sources/src/components/toast/index.js
  var Toast = (msg, {
    time = 1600,
    minWidth = "300px",
    height = "auto",
    ...
    let svg = information_circle_default;
    switch (status) {
      case "err":
        toast.style.background = "#e93c00";
        svg = exclamation_default;
        break;
      case "suc":
        toast.style.background = "#68c39f";
        svg = check_circle_default;
        break;
      default:
  ...
  function fadeIn(el, time) {
    ...
    var tick2 = function() {
      ...
      if (+el.style.opacity < 1) {
        window.requestAnimationFrame && requestAnimationFrame(tick2) || setTimeout(tick2, 10);
      }
    };
    tick2();
  }
  ...
  // sources/src/assets/svgs/arrow-circle-up.svg
  var arrow_circle_up_default = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">\n  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.707l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 001.414 1.414L9 9.414V13a1 1 0 102 0V9.414l1.293 1.293a1 1 0 001.414-1.414z" clip-rule="evenodd"/>\n</svg>\n';

  // sources/src/assets/svgs/trash.svg
  var trash_default = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">\n  <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"/>\n</svg>\n';

  // sources/src/assets/svgs/x.svg
  var x_default = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">\n  <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/>\n</svg>\n';

  // sources/src/assets/svgs/external-link.svg
  var external_link_default = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">\n  <path d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z"/>\n  <path d="M5 5a2 2 0 00-2 2v8a2 2 0 002 2h8a2 2 0 002-2v-3a1 1 0 10-2 0v3H5V7h3a1 1 0 000-2H5z"/>\n</svg>\n';

  // sources/src/assets/svgs/view-list.svg
  var view_list_default = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">\n  <path fill-rule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd"/>\n</svg>\n';

  // sources/src/assets/svgs/tag.svg
  var tag_default = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">\n  <path fill-rule="evenodd" d="M17.707 9.293a1 1 0 010 1.414l-7 7a1 1 0 01-1.414 0l-7-7A.997.997 0 012 10V5a3 3 0 013-3h5c.256 0 .512.098.707.293l7 7zM5 6a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"/>\n</svg>\n';

  // sources/src/pages/memos/index.js
  var getIndexesJson = Http({
  ...
  var getContent = (index) => {
    return Http({
      ...
      action: (state, content) => {
        return {
          ...state,
          content: { ...state.content, name: index, content },
          contents: [
            ...state.contents,
            {
              name: index,
  ...
  var setInputValue = (state, event) => {
    const str = event.target.value;
    const indexes = onSearchIndex(state, str);
    if (str === "") {
      return { ...state, inputValue: str, indexes, showIndexes: false };
    }
    return { ...state, inputValue: str, indexes, showIndexes: true };
  };
  var onInputFocus = (state) => {
    if (state.inputValue === "") {
      return { ...state, showIndexes: false };
    }
    return { ...state };
  };
  var setInputContent = (state, event) => {
  ...
  var removeContent = (state, index) => {
    if (state.content.name == index) {
      ...
      state.content = state.contents[id2 - 1];
    }
  ...
  var onClickCategory = (state, category) => {
    const indexes = [];
    category.files.forEach((v) => {
      const index = { name: v, upd_t: "" };
      indexes.push(index);
    });
    return { ...state, indexes, showIndexes: true };
  };
  var onSelect = (state, index) => {
    if (state.content.name == index) {
      return { ...state };
    }
  ...
  var onSearchIndex = (state, str) => {
    if (!str)
      state.indexes = initialState[0].indexes;
    const indexes = initialState[0].indexes.filter((e) => ~e.name.indexOf(str) ? true : false);
    return indexes;
  };
  var toggleShowIndex = (state) => {
  ...
  var initIndexes = getIndexesJson;
  var initCategories = getCategories;
  var initContent = [
    (dispatch) => {
  ...
  var initialState = [pureState, initIndexes, initContent, initCategories];
  onscroll = () => {
  ...
  app({
        ...
        h("div", { class: "content" }, [
          h("div", { class: "tabs" }, [
            h("div", {
              class: "tab",
              onclick: clearTabs,
              innerHTML: trash_default
            }),
            h("div", {
              class: "tab",
              onclick: () => copyUrl,
              innerHTML: external_link_default
            }),
            h("div", {
              class: "tab",
              onclick: () => toggleRaw,
              innerHTML: view_list_default
            }),
            h("div", {
            ...
            ...contents && contents.map((c) => h("div", {
              class: `tab${content.name === c.name ? " selected" : ""}`,
              onclick: () => [onSelect, c.name],
              innerHTML: c.name === "memo" ? pencil_alt_default : c.name == "category" ? tag_default : ""
            }, [
              c.name !== "memo" && c.name !== "category" && h("span", { class: "tab-label" }, text(c.name)),
              c.name !== "memo" && c.name !== "category" && h("div", {
          ...
          h("div", { class: `indexes  ${showIndexes ? "showIndexes" : "hide"}` }, indexes && indexes.map((index) => h("span", { class: "index", onclick: setContent }, text(index.name)))),
          getContentType(content) === "memo" && h("div", { class: "tab-memo" }, [
            h("textarea", {
              rows: 15,
          ...
          getContentType(content) === "category" && h("div", { class: "tab-content tab-category" }, getCategories && categories.map((c) => c.files && c.files.length > 1 && h("div", {
            class: "category",
          ...
          getContentType(content) === "default" && h("div", {
            class: `tab-content ${content.content ? "" : "no-content"}`,
            innerHTML: rawMode ? content.content : parse(content.content)
          }),
          h("div", {
            id: "top",
            class: "svg-top hide",
            innerHTML: arrow_circle_up_default,
            onclick: Top
          })
        ])
      ])
    ...
    subscriptions: (state) => [
      state.content && tick((state2) => {
        const name = state2.content && state2.content.name;
        if (name && name !== "memo") {
