(() => {
  ...
  // sources/src/modules/js/doper.js
  var require_doper = __commonJS({
    "sources/src/modules/js/doper.js"(exports, module) {
      var htmlTester = /^<.*>$/g;
      var Doper = class {
      ...
      var doper2 = function(dom, parent, params, css) {
        if (!dom)
          return;
        let _dom = getDom(dom);
  ...
  // sources/src/pages/index.js
  var doper = require_doper();
  app({
    init: {},
