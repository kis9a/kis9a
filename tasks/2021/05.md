...
- [x] [GitHub - mattn/docx2md: Convert Microsoft Word Document to Markdown](https://github.com/mattn/docx2md)
- [x] memos2json.go checkError function exclude.

<!--Functions usecase ref{{{-->
