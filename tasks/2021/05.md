...
- [x] read [any.js](https://anyjs.evolany.com/tasks/2021/05.md/quickstart)
...
- [ ] /kis9a fix Uncaught DOMException: Failed to execute 'removeChild' on 'Node': The node to be removed is not a child of this node.
- [ ] /kis9a style: fix textarea width.
...
- [ ] /kis9a hypeapp minimal routing demo only hyperapp syntax.
- [ ] plantuml syntaxs collection to can actually use with scrooloose/vim-slumlord.
- [ ] /kis9a content search.
- [ ] /kis9a sticky tabline to header.
- [ ] /kis9a /memos add memos directory to path.
- [ ] /kis9a manage common meta-tags with js.
