...
REST-API に比べて gRPC は速いうえに IF 仕様とソースコードの乖離発生を防げるし考えることが少ない
...
awk '{$1=""}1' first column to empty.

<!--Functions ref{{{-->

```
TestProvidersSchemaCmd(t *testing.T)
TestDestroyCmd(t *testing.T)
TestShowCmd(t *testing.T)
TestShowStateFileCmd(t *testing.T)
TestShowPlanFileCmd(t *testing.T)
TestShowPlanFileRawCmd(t *testing.T)
TestOutputCmd(t *testing.T)
TestPlanCmd(t *testing.T)
TestRefreshCmd(t *testing.T)
TestStateRmCmd(t *testing.T)
TestParsePlaintextVersionOutput(t *testing.T)
TestParseJsonVersionOutput(t *testing.T)
TestVersionInRange(t *testing.T)
TestCompatible(t *testing.T)
TestImportCmd(t *testing.T)
TestParseWorkspaceList(t *testing.T)
TestInitCmd(t *testing.T)
TestApplyCmd(t *testing.T)
TestMergeUserAgent(t *testing.T)
TestMain(m *testing.M)
TestSetEnv(t *testing.T)
TestCheckpointDisablePropagation(t *testing.T)
TestNoTerraformBinary(t *testing.T)
TestWorkspace_default_only(t *testing.T)
TestWorkspace_does_not_exist(t *testing.T)
TestWorkspace_already_exists(t *testing.T)
TestWorkspace_multiple(t *testing.T)
TestMain(m *testing.M)
TestDestroy(t *testing.T)
TestProvidersSchema(t *testing.T)
TestProvidersSchema_versionMismatch(t *testing.T)
TestShow(t *testing.T)
TestShow_errInitRequired(t *testing.T)
TestShow_versionMismatch(t *testing.T)
TestShowStateFile012(t *testing.T)
TestShowStateFile013(t *testing.T)
TestShowStateFile014(t *testing.T)
TestShowPlanFile012_linux(t *testing.T)
TestShowPlanFile013(t *testing.T)
TestShowPlanFile014(t *testing.T)
TestShowPlanFileRaw012_linux(t *testing.T)
TestShowPlanFileRaw013(t *testing.T)
TestShowPlanFileRaw014(t *testing.T)
TestShowBigInt(t *testing.T)
TestOutput_noOutputs(t *testing.T)
TestPlan(t *testing.T)
TestPlanWithState(t *testing.T)
TestRefresh(t *testing.T)
TestVersion(t *testing.T)
TestImport(t *testing.T)
TestValidate(t *testing.T)
TestInit(t *testing.T)
TestApply(t *testing.T)
TestStateMv(t *testing.T)
TestFormatString(t *testing.T)
TestFormatCheck(t *testing.T)
TestFormatWrite(t *testing.T)
TestFormat(t *testing.T)
TestFormat_warmFormatter(t *testing.T)
TestUpgrade012(t *testing.T)
TestStateRm(t *testing.T)
TestUnparsedError(t *testing.T)
TestMissingVar(t *testing.T)
TestTFVersionMismatch(t *testing.T)
TestContext_alreadyPastDeadline(t *testing.T)
TestContext_sleepNoCancellation(t *testing.T)
TestContext_sleepTimeoutExpired(t *testing.T)
TestContext_alreadyCancelled(t *testing.T)
TestWorkspaceNewCmd(t *testing.T)
TestStateMvCmd(t *testing.T)
TestFormat(t *testing.T)
TestUpgrade012(t *testing.T)
TestFindExactVersion(t *testing.T)
TestFindExactVersionPrerelease(t *testing.T)
TestLatestVersion(t *testing.T)
TestFindFallback(t *testing.T)
TestExactPath(t *testing.T)
TestGitRef(t *testing.T)
```
...
- [ ] rewrite awesome-aws-services golang script and add github actions.
- [ ] buy iphone 12 mini case and screen filter.
...
- [ ] research cache less. apple pay, paypay, linepay...
- [ ] sort out furnitures where in the NITORI.
