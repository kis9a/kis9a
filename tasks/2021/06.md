...
- [ ] read esbuild documentation and getting start.
...
- [ ] create new go packge to more simple interface hyperapp and esbuild like hugo. -> project name : hh
<!--{{{-->hugo
...
- /saveandrun how to separat watch envnt each environment.
- /saveandrun watcher add conf file to without restart server.
